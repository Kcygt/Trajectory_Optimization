...
% Define control points to encourage straight-line motion
% Place control points along the same line as targets
xCtrl = [xTarget(1,:); xTarget(end,:)];

% Final desired configuration
qDes = [0, 0, 0];

% Weights for optimization - increased weight for straight-line motion
...
% Bounds
tolRad = 0.01; % Reduced tolerance for more precise control
...
title('Improved Straight-Line Trajectory');
...
save('straightLine_data.mat', 'Opt','tOpt','yOpt','tInit','yInit','xTarget','xFinal');
...
function dxdt = myTwolinkwithprefilter_improved(t, x, qDes, tspan, wn1, wn2, wn3, xCtrl1, xCtrl2)
    ...
    % Improved phase transition logic with hysteresis
