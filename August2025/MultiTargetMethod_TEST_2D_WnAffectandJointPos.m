...
title('Comparison of Trajectories for Different Natural Frequencies');
...
% Overlay desired qDes
subplot(3,1,1); yline(qDes(1), '--k', 'LineWidth', 1);
subplot(3,1,2); yline(qDes(2), '--k', 'LineWidth', 1);
subplot(3,1,3); yline(qDes(3), '--k', 'LineWidth', 1);
