...
extern "C" HAPTIC_API void haDataLoggerFreeMatrix     ( const int inFlushSizeMax, const int inColumnCount, matrix& ioMatrix );
...
extern "C" HAPTIC_API int  haDataLoggerStartThread    ( long inDataLogger, const char* inFileName );
