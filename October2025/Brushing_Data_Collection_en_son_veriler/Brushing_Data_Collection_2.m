...
springConstant           = 200;           % spring value
dampCoefficient          = [30.0,30.0,30.0]; % Damp Coefficient
...
%     [retVal, response] = haSendCommand(hapticMasterDeviceHandle, 'set myDamper dampcoef [30.0,30.0,30.0]');
...
%      [retVal, response] = haSendCommand(hapticMasterDeviceHandle, 'set myDamper dampcoef [30.0, 30.0, 30.0]');
    ...
    %     bShouldStop = 0;
    completeMatrix_play_2 = zeros(1,12,'double');
    springPositionVector = homePositionVector;
    i = 2;
    ...
    while i <= size(completeMatrix_record, 1)
        ...
        [retVal, outputVector] = calllib( 'HapticAPI2', 'haDataLoggerFlushVector', dataLoggerDeviceHandle, outputVector );
        outputMatrix = reshape ( outputVector(1:retVal*matrixColumnCount), retVal, matrixColumnCount );
        completeMatrix_play_2 = vertcat ( completeMatrix_play_2, outputMatrix );
...
plot(completeMatrix_play_2(2:end, 2), completeMatrix_play_2(2:end, 5), 'k--')
save demo12_.mat completeMatrix_record completeMatrix_play