...
dampCoefficient          = [50.0,50.0,50.0]; % Damp Coefficient
...
homePositionVector = [-0.04,0.0,-0.196 ]';
...
%        0.1822355,  0.0000000,  0.9832549 ];
    ...
    while t <= 16
        ...
        if t > 16
            ...
            plot(completeMatrix_play(2:end,3), completeMatrix_play(2:end,5),'c+')
            ...
            plot(completeMatrix_play(2:end,2),completeMatrix_play(2:end,12), 'c--')
            disp('first if')
...
%-----------------------------------
% subplot(2,1,1),hold on, grid on, xlabel('x-Direction [m]'), ylabel('z-Direction [m]')
% plot(completeMatrix_play1(2:end,3), completeMatrix_play1(2:end,5),'k--')
% plot(x_d_star(:,1), x_d_star(:,3),'r-')
% plot(x_d_star2(:,1), x_d_star2(:,3),'k')
%
% subplot(2,1,2),hold on, grid on, xlabel('Time [s]'), ylabel('Force [N]')
% plot(t_vec, f_d_star(:, 3))
% plot(completeMatrix_play1(2:end,2),completeMatrix_play1(2:end,12), 'r--')

subplot(2,1,1),hold on, grid on, xlabel('x-Direction [m]'), ylabel('z-Direction [m]')
plot(completeMatrix_play1(2:end,3), completeMatrix_play1(2:end,5),'r+')
plot(x_d_star(:,1), x_d_star(:,3),'r-')
plot(x_d_star2(:,1), x_d_star2(:,3),'k')
