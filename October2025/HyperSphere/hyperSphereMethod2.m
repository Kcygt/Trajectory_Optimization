...
% Optimization
objectiveFunc = @(params) objectiveFunction(params, qDes, wt, xTarget, xFinal, numControlPoints,radius);
...
% Objective Function
function error = objectiveFunction(prms, qDes, wt, xTarget, xFinal, numControlPoints,radius)
    tUni = 0:0.001:prms(1);
