...
Opt = [tOpt, ...
       ...
       0.730407636217632   2.419714064852254   1.085093134460414, ...
       -0.100792879495735, -0.12846054140405, 0.0024602513732, ...
...
paramIdx = 2;
for i = 1:numWnSets
    wnOpt{i} = Opt(paramIdx:paramIdx+2);
    paramIdx = paramIdx + 3;
end
for i = 1:numControlPoints
