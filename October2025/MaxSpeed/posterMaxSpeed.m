...
leg_names1 = {'Physical robot at normal speed','Simulation on digital twin','Reference trajectory followed by optimization'};
...
sgtitle(tl, '', 'FontWeight', 'bold', 'FontSize', 14);
