...
% % Data 10
% tspan = 1.92988;
% zeta = [0.74941      0.82108     0.733546  ];
% wn = [7.5277      16.5885      8.62631];

% % Data 11
% tspan = 1.66514;
% zeta = [ 0.727287     0.730442     0.721689 ];
% wn = [6.1908      8.55466      15.6824];


% % Data 12
% tspan = 1.8469;
% zeta = [  0.73358     0.83923     0.78457 ];
% wn = [ 0.10025      2.8951      2.4026 ];


% Data 13
tspan = 1.9644;
zeta = [  0.75529           1      0.5876 ];
wn = [ 1.066      2.1154      1.3248 ];
...
% Initial Condition
[tInit, yInit] = ode23s(@(t, x) myTwolinkwithprefilter(t, x, qDes, tspan,  zeta,wn), [0 tspan], zeros(12, 1));
[tOpt, yOpt] = ode23s(@(t, x) myTwolinkwithprefilter(t, x, qDes, tspan1,  zeta,wn1), [0 tspan1], zeros(12, 1));
