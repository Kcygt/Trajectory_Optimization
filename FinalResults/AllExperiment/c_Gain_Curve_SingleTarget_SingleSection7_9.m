...
% Data 7
% tspan =1.53405;
% zeta = [0.75196     0.564448     0.960431];
% wn = [9.84823      18.5548      5.14193 ];
% Kp = [ 60.5674      60.4803      59.9803];
% Kd = [ 89.6256      88.6417      91.7912];

% % % Data 8
% tspan = 1.904974;
% zeta = [ 0.9160724     0.8638073     0.5727551  ];
% wn = [ 10.69823      3.682638      7.553252 ];
% Kp = [ 53.38334      40.00147      51.29529 ];
% Kd = [ 96.4811      92.42004      107.2134 ];

% % Data 9
tspan = 1.876174;
zeta = [ 0.7378902     0.7642485     0.7004045  ];
wn = [ 17.6893       15.8735      13.69968  ];
Kp = [ 59.56614      66.37721      46.04473  ];
Kd = [ 108.7981      131.4733      94.46455 ];
...
% Initial Condition
[tOut, yOut] = ode23s(@(t, x) myTwolinkwithprefilter(t, x, qDes, tspan,  zeta,wn,Kp,Kd), [0 tspan], zeros(12, 1));
[tOut1, yOut1] = ode23s(@(t, x) myTwolinkwithprefilter(t, x, qDes, tspan1,  zeta,wn1,Kp,Kd), [0 tspan1], zeros(12, 1));
...
% Save Results
save(sprintf('Gdata%d.mat', dataNum), 'tOut1','yOut1');
