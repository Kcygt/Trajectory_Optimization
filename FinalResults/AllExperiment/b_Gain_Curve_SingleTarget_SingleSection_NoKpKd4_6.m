...
% Parameters
tspan = 1.7917;
zeta = [ 0.9958    0.6091    0.8745    ];
wn = [  11.9855    4.2149    4.5718];

Gain = 5;
tspan1 = tspan / Gain;
zeta1 = [0.50211     0.71177     0.94338];
wn1 = wn * Gain;


% Initial Condition
[tOut, yOut] = ode23s(@(t, x) myTwolinkwithprefilter(t, x, qDes, tspan,  zeta,wn), [0 tspan], zeros(12, 1));
[tOut1, yOut1] = ode23s(@(t, x) myTwolinkwithprefilter(t, x, qDes, tspan1,  zeta1,wn1), [0 tspan1], zeros(12, 1));
