...
tspan = [ 1.5816           4      6.9234 ];
wn1 =  [ 1.2161      5.1156       5.471 ];
wn2 =  [ 1.2161      4.2104      4.6096 ];
wn3 =  [ 1.2161       6.287      2.1492 ];
xCtrl(1,:)= [   0    0.043232    0.029621 ] + [0 0.01 0.01];
xCtrl(2,:)= [   0   0.0068752  -0.0019045 ] - [0 0.01 0.01];
