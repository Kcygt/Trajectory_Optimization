...
[init_T, init_Y] = ode45(@(t, x) myTwolinkwithprefilter(t, x, wn, initParams(1:2), qDes, bj, kj),   [0 initParams(2)], InitialCondition);
...
[t, y] = ode45(@(t, x) myTwolinkwithprefilter(t, x, optimalParams(3:4), optimalParams(1:2), qDes, optimalParams(5:6), optimalParams(7:8)), [0 optimalParams(2)], InitialCondition);
